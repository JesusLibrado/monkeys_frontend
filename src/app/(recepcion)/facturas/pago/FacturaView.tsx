...
const EstatusFacturaBadge = (props: { estatus: string }) => {
  switch (props.estatus) {
    case "CREADA":
      return (
        <span className="text-end badge badge-outline-danger rounded-pill px-1 fs-12 mb-3">
          {" "}
          Pendiente{" "}
        </span>
      );
    case "PAGADA":
      return (
        <span className="text-end badge badge-outline-success rounded-pill px-1 fs-12 mb-3">
          {" "}
          Pagada{" "}
        </span>
      );
    case "CANCELADA":
      return (
        <span className="text-end badge badge-outline-dark rounded-pill px-1 fs-12 mb-3">
          {" "}
          Cancelada{" "}
        </span>
      );
...
const FacturaView = (props: { facturaId: string }) => {
  ...
  const nombreCliente = (): string =>
    facturaData.evento ? facturaData.evento.nombreCliente : "";
            ...
            <tbody>
              ...
              <tr>
                <td className="fw-medium">
                  Descuento <small className="text-muted">(?)</small>
                </td>
