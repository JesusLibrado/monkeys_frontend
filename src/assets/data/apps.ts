...
export const kanbanTasksData: KanbanTaskType[] = [
  {
    ...
    description:
      "To collaborate with users in a repository that belongs to your personal account",
    image: small1,
    variant: "warning",
    views: 5,
    priority: "High",
  ...
  },
  {
    ...
    description:
      "Navigation bars design best practices involve focusing on functionality.",
    variant: "pink",
    views: 2,
    share: 24,
    priority: "Low",
