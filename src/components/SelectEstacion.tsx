...
const SelectEstacion = (props: {
    ...
    const [idsDictionary, setIdsDictionary] = useState<Map<string, string>>(new Map());
    ...
    useEffect(()=>{
        if(data) {
            ...
            setSelectedEstacion(estacionOptions.find((option)=>option.value==props.estacionId));
    ...
    useEffect(()=>{
        if(selectedEmpleado) {
            ...
            setSelectedEstacion(estacionOptions.find((option)=>option.value==assignedEstacionId));
    ...
    useEffect(()=>{
        if(selectedEstacion) {
            ...
            setSelectedEmpleado(empleadoOptions.find((option)=>option.value==assignedEmpleadoId));
