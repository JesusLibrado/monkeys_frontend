    ...
    <div className="topbar-item">
      <Dropdown align={'end'}>
        ...
        <DropdownMenu className="dropdown-menu-end">
          {
            flags.map((flag, idx) => (
              <a href="" className="dropdown-item" key={idx} data-translator-lang="en">
                <Image src={flag.flag} alt="user-image" className="me-1 rounded" height={18} data-translator-image /> <span className="align-middle">{flag.language}</span>
              </a>
            ))
          }
        </DropdownMenu>
