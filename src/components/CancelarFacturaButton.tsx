...
const CancelarFacturaButton = (props: { facturaId: string }) => {
  const [cancelarFactura, { data, loading, error }] =
    useMutation(CANCEL_FACTURA);
        ...
        <div className={`modal-filled bg-danger`}>
          <ModalBody className="p-4">
            <div className="text-center">
              ...
              <p className="mt-3">
                Al continuar, ya no podrás realizar el cobro de productos o
                servicios.
                <br />
                <br />
                Click en Aceptar para continuar, de lo contrario da click fuera
                del recuadro.
              </p>
              <Button variant="light" className="my-2" onClick={handleSubmit}>
                {loading ? <Spinner className="fs-10" /> : "Aceptar"}
              </Button>
            </div>
          </ModalBody>
        </div>
