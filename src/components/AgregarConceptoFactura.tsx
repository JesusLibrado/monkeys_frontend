...
const AgregarConceptoFactura = (props: {
  ...
  const [createConceptoFactura, { loading, error, data }] = useMutation(
    CREATE_CONCEPTO_FACTURA,
  );
  ...
  const disabledSubmitButton =
    total < 1 || cantidad < 1 || cantidad > cantidadDisponible;
    ...
    createConceptoFactura({
      variables: {
        createConceptoFacturaInput: {
          ...
          cantidad: cantidad,
          servicioId:
            selectedConcepto.servicioId != ""
              ? selectedConcepto.servicioId
              : "",
          productoId:
            selectedConcepto.productoId != ""
              ? selectedConcepto.productoId
              : "",
        },
      },
  ...
  return (
    <tr key="add-concepto-factura-row">
      ...
      <td className="text-start">
        <div>
          <SelectConcepto
            onSelectedConceptoChange={handleSelectedConceptoChange}
          />
        </div>
      </td>
      <td>
