...
export const notificationData: NotificationType[] = [
  {
    ...
    title: (
      <>
        <span className="fw-medium text-body">Glady Haid</span> commented on{" "}
        <span className="fw-medium text-body">paces admin status</span>
      </>
    ),
    image: {
      image: userAvatar2,
  ...
  },
  {
    ...
    title: (
      <>
        <span className="fw-medium text-body">Tommy Berry</span> donated{" "}
        <span className="text-success">{currency}100.00</span> for{" "}
  ...
  },
  {
    ...
    title: (
      <>
        You withdraw a{" "}
        <span className="fw-medium text-body">{currency}500</span> by{" "}
        <span className="fw-medium text-body">New York ATM</span>
      </>
    ),
    icon: {
  ...
  },
  {
    ...
    title: (
      <>
        <span className="fw-medium text-body">Richard Allen</span> followed you
        in <span className="fw-medium text-body">Facebook</span>
      </>
    ),
    image: {
      image: userAvatar7,
  ...
  },
  {
    ...
    title: (
      <>
        <span className="fw-medium text-body">Victor Collier</span> liked you
        recent photo in <span className="fw-medium text-body">Instagram</span>
      </>
    ),
    image: {
      image: userAvatar10,
