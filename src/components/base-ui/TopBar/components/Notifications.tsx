        ...
        >
          ...
          >
            {notifications.map((item, idx) => (
              <div
                className="notification-item dropdown-item py-2 text-wrap"
                id="notification-1"
                key={idx}
              >
                <span className="d-flex align-items-center">
                  {item.image ? (
                    <span className="me-3 position-relative flex-shrink-0">
                      ...
                      <span
                        className={`position-absolute rounded-pill bg-${item.image.variant} notification-badge`}
                      >
